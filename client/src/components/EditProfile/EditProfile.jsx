...
// TODO: delete if you're going to allow editing on the profile page
const EditProfile = () => {
...
//     useEffect(() => {
//         if (isEmpty(profile)) getCurrentUserProfile();
//         setFormData(profileInfoAndSocial);
//     }, [getCurrentUserProfile, profile, profileInfoAndSocial]);
